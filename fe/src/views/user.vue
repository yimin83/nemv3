    ...
    <v-layout row wrap>
      ...
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn flat color="orange" @click="delDialog(user._id)">삭제</v-btn>
        </v-card-actions>
      </v-card>
      </v-flex>
      <v-btn
    ...
    <v-dialog v-model="dialog" persistent max-width="500px">
      ...
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn color="blue darken-1" flat @click.native="dialog = flase">삭제</v-btn>
...
export default {
  ...
  methods: {
    ...
    mdUp () {
      // console.log('mdUp')this.userName = ''
      this.userName = ''
      this.userAge = ''
      this.dialog = true
    },
